...
// AE: as the cert-manager still uses v0.20.0 instead of v1.9.0 in the imports, we need to make this explicit,
// otherwise build will fail, see https://github.com/open-telemetry/opentelemetry-go/issues/2938 for details.
replace (
...
// CVE-2022-27664
replace golang.org/x/net v0.0.0-20220722155237-a158d28d115b => golang.org/x/net v0.0.0-20220909164309-bea034e7d591
